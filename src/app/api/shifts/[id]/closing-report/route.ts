...
export async function GET(
  ...
  try {
    ...
    const isCustomInputItem = (orderItem: any): boolean => {
      ...
      if (posFormatPattern.test(orderItem.variantName)) return true;
    ...
    const report = {
      ...
      paymentSummary: {
        ...
        wallet: walletTotal,
        talabat: talabatTotal,
        other: otherTotal,
        total: cashTotal + cardTotal + instapayTotal + walletTotal + talabatTotal + otherTotal
      },
      orderTypeBreakdown,
      totals: {
        sales: totalSales,
