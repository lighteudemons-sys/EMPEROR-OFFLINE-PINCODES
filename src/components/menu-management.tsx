...
export default function MenuManagement() {
  ...
  const handleCategorySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: any = {
        ...
        requiresCaptainReceipt: categoryFormData.requiresCaptainReceipt,
      };
  ...
  const handleEditCategory = (category: Category) => {
    ...
    setCategoryFormData({
      ...
      requiresCaptainReceipt: category.requiresCaptainReceipt || false,
    });
                  ...
                  <DialogContent className="w-full max-w-[95vw] sm:max-w-[500px] max-h-[90dvh] overflow-y-auto pb-safe">
                    <form onSubmit={handleCategorySubmit}>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <div className="flex items-center justify-between space-x-2 p-4 border rounded-lg bg-slate-50 dark:bg-slate-900">
                          <div className="space-y-0.5">
                            <Label htmlFor="requiresCaptainReceipt" className="text-base font-medium">
                              Captain Receipt
                            </Label>
                            <p className="text-xs text-slate-500 dark:text-slate-400">
                              Print simplified barista ticket for this category
                            </p>
                          </div>
                          <Switch
                            id="requiresCaptainReceipt"
                            checked={categoryFormData.requiresCaptainReceipt}
                            onCheckedChange={(checked) => setCategoryFormData({ ...categoryFormData, requiresCaptainReceipt: checked })}
                          />
                        </div>
                      </div>
                      <DialogFooter className="flex-col sm:flex-row gap-2 pt-4">
