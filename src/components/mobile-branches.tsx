          ...
          <div className="space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                {selectedBranch.shiftReportEmail && (
                  <div className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-slate-400 mt-0.5" />
                    <div className="flex-1">
                      <p className="text-sm text-slate-600">Shift Report Email</p>
                      <p className="font-medium text-sm">{selectedBranch.shiftReportEmail}</p>
                    </div>
                  </div>
                )}
              </CardContent>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <p className="text-xs text-slate-500">Shift reports sent here automatically on close</p>
              </div>
              <div className="grid gap-2">
