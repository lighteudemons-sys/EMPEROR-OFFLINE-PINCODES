...
import { getMonthOptions, formatPeriodLabel } from '@/lib/date-range';
...
export default function CostManagement() {
  ...
  // Generate period options — last 36 months (3 years back)
  const getPeriodOptions = () => getMonthOptions(36);
  ...
  // Initialize form with user's branch when component mounts
  useEffect(() => {
    resetForm();
  ...
  const getPeriodLabel = (period: string) => formatPeriodLabel(period);
