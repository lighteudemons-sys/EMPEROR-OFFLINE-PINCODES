...
export function MobilePOS() {
  ...
  const handleCardPaymentSubmit = async () => {
    if ((paymentMethodDetail === 'CARD' || paymentMethodDetail === 'INSTAPAY' || paymentMethodDetail === 'MOBILE_WALLET') && !cardReferenceNumber.trim()) {
  ...
  const processCheckout = async (paymentMethod: 'cash' | 'card', cardRefNumber?: string, paymentMethodDetailParam?: 'CARD' | 'INSTAPAY' | 'MOBILE_WALLET' | 'TALABAT') => {
    setProcessing(true);
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <RadioGroup value={paymentMethodDetail} onValueChange={(v: any) => setPaymentMethodDetail(v)}>
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="TALABAT" id="talabat" />
                  <Label htmlFor="talabat" className="font-normal">Talabat</Label>
                </div>
              </RadioGroup>
            </div>
                  ...
                  >
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        <p className="font-bold text-emerald-600">
                          {canSeeFinancials(user) ? formatCurrency(order.totalAmount) : '•••'}
                        </p>
